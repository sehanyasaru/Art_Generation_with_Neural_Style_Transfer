...
st.write('Upload a content image and a style image, and see the result of applying style transfer.')

content_image = st.file_uploader('Upload a Content Image', type=['jpg', 'jpeg', 'png'])
...
if content_image and style_image:
    ...
    st.image(tensor_to_image(content_image))

    st.write("Style Image:")
    st.image(tensor_to_image(style_image))
    ...
    epochs = st.slider('Number of Epochs', min_value=1, max_value=500, value=50)
